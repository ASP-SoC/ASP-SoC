...
set 	Audio_nios_cpu_wrapper 	Audio_nios_cpu_debug_slave_wrapper:the_Audio_nios_cpu_debug_slave_wrapper
set 	Audio_nios_cpu_jtag_tck 	Audio_nios_cpu_debug_slave_tck:the_Audio_nios_cpu_debug_slave_tck
set 	Audio_nios_cpu_jtag_sysclk 	Audio_nios_cpu_debug_slave_sysclk:the_Audio_nios_cpu_debug_slave_sysclk
