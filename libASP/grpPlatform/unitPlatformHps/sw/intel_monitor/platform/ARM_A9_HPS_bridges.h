...
#define PIO_HEX3_5_RESET_VALUE 15
...
#define PIO_HEX0_2_RESET_VALUE 15
...
/*
 * Macros for device 'ASP_fir_right', class 'ASP_SoC_FIR'
 * The macros are prefixed with 'ASP_FIR_RIGHT_'.
 * The prefix is the slave descriptor.
 */
#define ASP_FIR_RIGHT_COMPONENT_TYPE ASP_SoC_FIR
#define ASP_FIR_RIGHT_COMPONENT_NAME ASP_fir_right
#define ASP_FIR_RIGHT_BASE 0x200
#define ASP_FIR_RIGHT_SPAN 512
#define ASP_FIR_RIGHT_END 0x3ff

/*
 * Macros for device 'ASP_fir_left', class 'ASP_SoC_FIR'
 * The macros are prefixed with 'ASP_FIR_LEFT_'.
 * The prefix is the slave descriptor.
 */
#define ASP_FIR_LEFT_COMPONENT_TYPE ASP_SoC_FIR
#define ASP_FIR_LEFT_COMPONENT_NAME ASP_fir_left
#define ASP_FIR_LEFT_BASE 0x400
#define ASP_FIR_LEFT_SPAN 512
#define ASP_FIR_LEFT_END 0x5ff
