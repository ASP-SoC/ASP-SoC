	Platform u0 (
		...
		.dds_left_strobe_export          (<connected-to-dds_left_strobe_export>),          //          dds_left_strobe.export
		.dds_right_strobe_export         (<connected-to-dds_right_strobe_export>),         //         dds_right_strobe.export
		...
		.i2s_codec_iadcdat               (<connected-to-i2s_codec_iadcdat>),               //                i2s_codec.iadcdat
		.i2s_codec_iadclrc               (<connected-to-i2s_codec_iadclrc>),               //                         .iadclrc
		.i2s_codec_ibclk                 (<connected-to-i2s_codec_ibclk>),                 //                         .ibclk
		.i2s_codec_idaclrc               (<connected-to-i2s_codec_idaclrc>),               //                         .idaclrc
		.i2s_codec_odacdat               (<connected-to-i2s_codec_odacdat>),               //                         .odacdat
		.i2s_gpio_iadcdat                (<connected-to-i2s_gpio_iadcdat>),                //                 i2s_gpio.iadcdat
		.i2s_gpio_iadclrc                (<connected-to-i2s_gpio_iadclrc>),                //                         .iadclrc
		.i2s_gpio_ibclk                  (<connected-to-i2s_gpio_ibclk>),                  //                         .ibclk
		.i2s_gpio_idaclrc                (<connected-to-i2s_gpio_idaclrc>),                //                         .idaclrc
		.i2s_gpio_odacdat                (<connected-to-i2s_gpio_odacdat>),                //                         .odacdat
		...
		.strobe_export                   (<connected-to-strobe_export>),                   //                   strobe.export
		.switches_export                 (<connected-to-switches_export>),                 //                 switches.export
		.white_noise_left_strobe_export  (<connected-to-white_noise_left_strobe_export>),  //  white_noise_left_strobe.export
		.white_noise_right_strobe_export (<connected-to-white_noise_right_strobe_export>), // white_noise_right_strobe.export
